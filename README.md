...
| [04. Interceptor 체인 — gRPC 미들웨어 패턴](./security-auth/04-interceptor-chain.md) | ClientInterceptor/ServerInterceptor 인터페이스 구조, 로깅·인증·분산 추적·재시도를 체인으로 조합하는 방법, Interceptor 실행 순서와 Context 전달, `@GrpcGlobalInterceptor`로 Spring Bean 전역 등록 |
